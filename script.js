/* ============================================================
JOHNSON SMART FILM — Main JavaScript v4.1
Zero-Bug Edition — Final Version
============================================================ */
...
Clone children (not the whole track) so animation stays consistent
═══════════════════════════════════════════════════════════ */
const tickerTrack = document.querySelector('.hero__ticker-track');
if (tickerTrack && tickerTrack.children.length > 0) {
// Clone only the original children and append them — NOT the whole track
...
// Back to home with loader — FIXED to use clean URL
if (backToHome) {
...
/* ═══════════════════════════════════════════════════════════
15. LAZY LOAD IMAGES — add 'loaded' class when visible
═══════════════════════════════════════════════════════════ */
