...
image: '/listing_main_2024_jetour_t2_UAE-2.jpg',
specs: [
...
image: '/pexels-pho-tomass-883344227-32364025.jpg',
specs: [
{ icon: 'fa-layer-group', label: 'Total Thickness', value: '7.5 mil (190\u03bc)' },
{ icon: 'fa-shield-halved', label: 'TPU Thickness', value: '6 mil' },
{ icon: 'fa-wand-magic-sparkles', label: 'Self-Healing Coat', value: '15 \u03bcm' },
...
image: '/Luxury-Car-PNG-Free-File-Download.png',
specs: [
...
let currentCat = 'products';
let currentId = CATALOG.products[0].id;
